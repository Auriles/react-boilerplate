...
class SideMenus3 extends Component {
    render() {
        return (
            <>
                <nav class="flex flex-col space-y-1">
                    <a
                        href=""
                        class="flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg group"
                    >
                        <svg
                    ...
                    >
                        ...
                        <span
                        class="ml-auto shrink-0 rounded-full bg-gray-100 py-0.5 px-3 text-xs text-gray-600 group-hover:bg-gray-200 group-hover:text-gray-700"
                        >
                        5
                        </span>
                    </a>
