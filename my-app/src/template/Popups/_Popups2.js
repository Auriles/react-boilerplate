...
class Popups2 extends Component {
    render() {
        return (
            <>
                <div class="p-8 bg-white border border-blue-100 shadow-lg rounded-2xl" role="alert">
                    <div class="items-center sm:flex">
                        <span class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-white bg-blue-400 rounded-full">
                        ...
                        <p class="mt-3 text-lg font-medium sm:mt-0 sm:ml-3">You've got a new message</p>
                    </div>
