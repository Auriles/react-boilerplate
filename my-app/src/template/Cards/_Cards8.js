...
class Cards8 extends Component {
    render() {
        return (
            <div className='body-cards8'>
                <div className="container-cards8">
                    <article class="p-1 shadow-xl rounded-2xl bg-gradient-to-r from-red-400 to-red-600">
                        <a href="" class="flex flex-col justify-end h-full p-6 bg-gray-900 sm:p-8 rounded-xl hover:bg-opacity-90">
                            <div class="mt-16">
