...
class Cards7 extends Component {
    render() {
        return (
            <div className='body-cards7'>
                <div className="container-cards7">
                    <a
                    href=""
                    class="relative block overflow-hidden bg-center bg-no-repeat bg-cover rounded-xl cards7"
                    >
                        <span
